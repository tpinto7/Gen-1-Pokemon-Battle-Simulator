...
namespace ActualMoves
{
	...
	class Withdraw : Moves
	{
		public Withdraw( ) : base( "Withdraw", "Status", new Types("Water"), 40, 64, 0 ){ }
	...
	class Roar : Moves
	{
		public Roar( ) : base( "Roar", "Status", new Types("Normal"), 20, 32, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			defenderName.SwitchRandomPokemon( );
			base.SubtractPP( 1 );
	...
	class FireBlast : Moves
	{
		...
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			if( base.MoveAccuracy( attacker, defender ) < 8500 )
			{
				base.GenericAttackMove( base.Type, attacker, defender, attackerName, defenderName, 120 );
	...
	class Ember : Moves
	{
		public Ember( ) : base( "Fire", "Special", new Types("Fire"), 25, 32, 0 ){ } 
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			base.GenericAttackMove( base.Type, attacker, defender, attackerName, defenderName, 40);
			base.SubtractPP( 1 );
	...
	class Crabhammer : Moves
	{
		...
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			if( base.MoveAccuracy( attacker, defender ) < 8500 ) base.GenericAttackMoveSpecialCrit( base.Type, attacker, defender, attackerName, defenderName, 90, 2 );
	...
	class HornDrill : Moves
	{
		public HornDrill( ) : base( "Horn Drill", "Physical", new Types("Normal"), 5, 8, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			base.GenericAttackMoveAccuracy( base.Type, attacker, defender, attackerName, defenderName, 65535, 30 );
			if( defender.Health == 0 ) WriteLine( "It's a one hit KO!" );
	...
	class Supersonic : Moves
	{
		...
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			if( base.MoveAccuracy( attacker, defender ) < 5500 )
			{
				defender.IsConfused = true;
				WriteLine( $"{defenderName}'s {defender} has become confused!" );
			}
	...
	class Psywave : Moves
	{
		public Psywave( ) : base( "Psywave", "Special", new Types("Psychic"), 15, 24, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			if( base.MoveAccuracy( attacker, defender ) < 8000 )
			{
				Random randomDamage = new Random( );
				double damage = randomDamage.Next( ( int ) ( attacker.Level * 1.5 ) );
				defender.Health -= damage;
				base.DisplayHealth( attacker, defender, attackerName, defenderName, damage );
			}
			else WriteLine( "Psywave has missed!" );
			base.SubtractPP( 1 );
		}
	}
	...
	{
		public TakeDown( ) : base( "Take Down", "Physical", new Types("Normal"), 20, 24, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			double damage = base.GenericAttackMoveAccuracy( base.Type, attacker, defender, attackerName, defenderName, 90, 85);
	...
	class DoubleEdge : Moves
	{
		public DoubleEdge( ) : base( "Double Edge", "Physical", new Types("Normal"), 15, 24, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			double damage = base.GenericAttackMove( base.Type, attacker, defender, attackerName, defenderName, 40);
			attacker.Health -= damage / 4;
	...
	class PinMissile : Moves
	{
		public PinMissile( ) : base( "Pin Missile", "Physical", new Types("Bug"), 20, 24, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			// if one of the hits breaks the target's substitute, the move ends
			double damage = base.GenericAttackMoveAccuracy( base.Type, attacker, defender, attackerName, defenderName, 14, 85);
			if( damage > 0 )
			{
				int hits = 0;
				if( oddsOfStatusEffect < 3750 ) hits = 1;
	...
	class LovelyKiss : Moves
	{
		public LovelyKiss( ) : base( "Lovely Kiss", "Status", new Types("Normal"), 10, 16, 0 ){ }
		public override void ExecuteMove( Pokemon attacker, Pokemon defender, Player attackerName, Player defenderName )
		{
			if( !defender.ImpairedStatus )
			{
				...
				else WriteLine( $"{attackerName}'s {attacker}'s lovely kiss missed!" );
			}	
